...
public class Provider implements IProvider {
    public Response createEvent(String name, String price, List<String> photos) {
    ...
    public Response updateEvent(long id, String name, String price, List<String> photos) {
        try {
