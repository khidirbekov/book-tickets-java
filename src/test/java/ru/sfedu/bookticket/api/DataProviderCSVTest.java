...
class DataProviderCSVTest extends BaseTest {
    ...
    DataProviderCSVTest() throws IOException {
        this.provider.setPATH(ConfigurationUtil.getConfigurationEntry(Constants.CSV_TEST_PATH));
    }

    @BeforeEach
    public void initTestData() throws IOException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
